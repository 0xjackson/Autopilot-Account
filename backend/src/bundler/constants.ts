...
export const CONTRACTS = {
  FACTORY: (process.env.FACTORY_ADDRESS || "0x7673F1EBF4eA4e4F2CCb9bf44dCdeF5a5Ba76B94") as Address,
  MODULE: (process.env.AUTO_YIELD_MODULE_ADDRESS || "0x598d23dC23095b128aBD4Dbab096d48f9e4b919B") as Address,
