...
export const CONTRACTS = {
  FACTORY: (process.env.FACTORY_ADDRESS || "0xc627874FE7444f8e9750e5043c19bA01E990D581") as Address,
  MODULE: (process.env.AUTO_YIELD_MODULE_ADDRESS || "0xC35Eeb30a36d1ac157B41719BEAf513a0C557Bce") as Address,
